    ...
    <section className="section !pt-0">
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <Link
          ...
          style={{
            background: "linear-gradient(135deg, rgba(99,102,241,0.55) 0%, rgba(59,130,246,0.45) 100%)",
          }}
        >
          {/* Glass inner */}
          <div
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold text-white drop-shadow-sm">About Us</h3>
        ...
        <Link
          ...
          style={{
            background: "linear-gradient(135deg, rgba(245,158,11,0.55) 0%, rgba(16,185,129,0.45) 100%)",
          }}
        >
          {/* Glass inner */}
          <div
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold text-white drop-shadow-sm">Join With Us</h3>
              <p className="mt-2 max-w-xs text-sm leading-relaxed text-white/80">
              ...
              <div className="mt-6 flex items-center gap-1.5 text-sm font-semibold text-yellow-200">
                View Open Roles <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
              </div>
            </div>
          </div>
        </Link>
