        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-sm text-white/60 pt-2">
            <p className="flex items-start gap-2.5">
              ...
              <span>2nd Floor, Hazratganj, Lucknow, Uttar Pradesh 226001, India</span>
            </p>
        ...
        <ul className="flex justify-center items-center gap-4 list-none p-0 m-0">
          ...
          <li className="relative group">
            <a 
              ...
              rel="noopener noreferrer" 
              aria-label="GitHub"
              className="relative flex items-center justify-center w-12 h-12 rounded-full bg-white/5 border border-white/15 text-white overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(36,38,42,0.6)] hover:border-[#24262a]"
            >
              <div className="absolute inset-x-0 bottom-0 w-full h-0 bg-[#24262a] transition-all duration-300 group-hover:h-full z-0"></div>
              <svg className="relative z-10 w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <span className="absolute -top-10 left-1/2 -translate-x-1/2 bg-[#24262a] text-white text-xs px-2.5 py-1 rounded-md opacity-0 visibility-hidden group-hover:opacity-100 group-hover:visibility-visible transition-all duration-300 pointer-events-none whitespace-nowrap shadow-lg">GitHub</span>
          </li>
          ...
          <li className="relative group">
            <a 
              ...
              rel="noopener noreferrer" 
              aria-label="YouTube"
              className="relative flex items-center justify-center w-12 h-12 rounded-full bg-white/5 border border-white/15 text-white overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,0,0,0.6)] hover:border-[#ff0000]"
            >
              <div className="absolute inset-x-0 bottom-0 w-full h-0 bg-[#ff0000] transition-all duration-300 group-hover:h-full z-0"></div>
              <svg className="relative z-10 w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
              </svg>
            </a>
            <span className="absolute -top-10 left-1/2 -translate-x-1/2 bg-[#ff0000] text-white text-xs px-2.5 py-1 rounded-md opacity-0 visibility-hidden group-hover:opacity-100 group-hover:visibility-visible transition-all duration-300 pointer-events-none whitespace-nowrap shadow-lg">YouTube</span>
          </li>
