...
import { CheckCircle2, CreditCard, Briefcase, Wallet, Building2 } from "lucide-react";
...
export default function ServicesContent() {
  const services = [
    ...
    {
      title: "Credit Card",
  description: "Premium credit cards matched to your spending profile",
  icon: <Wallet className="w-8 h-8 text-accent" />,
  stats: [
    { label: "Min. CIBIL Score:", value: "620+" },
    { label: "Card Types:", value: "8+ Categories" },
    { label: "Approval Time:", value: "3-7 days" }
  ],

  features: [
    "Cashback & Rewards Options",
